...
static int __init register_earlycon(char *buf, const struct earlycon_id *match)
{
	...
	/* DEBUG: For RK3399 UART2, don't set default uartclk here
	 * Let the setup function set it to 24MHz
	 */
	if (port->mapbase == 0xff1a0000UL) {
		/* RK3399 UART2: setup function will set uartclk to 24MHz */
		port->uartclk = 0; /* Force setup function to set it */
	} else {
